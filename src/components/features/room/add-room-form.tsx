...
const addRoomFormSchema = z.object({
  ...
  virtualTourUrl: z.string().optional().refine(val => !val || val.includes('kuula.co'), {
    message: "Please include a valid Kuula tour URL."
  }),
});
        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <CardContent className="space-y-6">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>360° Virtual Tour (Optional)</FormLabel>
                  <FormControl>
                    <Input placeholder="https://kuula.co/share/..." {...field} />
                  </FormControl>
                  <FormDescription>
                    Add a link to a Kuula.co virtual tour for this room.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
